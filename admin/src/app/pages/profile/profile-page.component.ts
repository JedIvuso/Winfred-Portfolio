  ...
  template: `
    <div class="page">
      ...
      <div class="error-banner" *ngIf="error">
        ⚠️ Could not connect to backend. Make sure NestJS server is running on
        port 3000.
      </div>
      ...
      <div class="profile-form" *ngIf="!loading && profile">
        ...
        <div class="section-card">
          ...
          <p class="section-desc">
            Upload your photos for the hero and about sections of the website.
          </p>
          ...
          <div class="photos-grid">
            ...
            <div class="photo-upload-block">
              <div class="photo-label">
                ...
                <span
                  >Large photo on the homepage (portrait, min 600×700px
                  recommended)</span
                >
              </div>
              <div
              ...
              <div class="upload-actions">
                <button
                  ...
                  [disabled]="!heroFile || uploading.hero"
                >
                  {{ uploading.hero ? "Uploading..." : "Upload Hero Photo" }}
                </button>
                <button
                  class="btn btn-danger"
                  *ngIf="profile.heroImage"
                  (click)="removeImage('heroImage')"
                >
                  Remove
                </button>
              </div>
              <div class="upload-success" *ngIf="uploadSuccess.hero">
                ✓ Hero photo updated successfully!
              </div>
              <input
                id="heroFileInput"
                type="file"
            ...
            <div class="photo-upload-block">
              <div class="photo-label">
                ...
                <span
                  >Photo shown in "About Me" (portrait or square, min 500×500px
                  recommended)</span
                >
              </div>
              <div
              ...
              <div class="upload-actions">
                <button
                  ...
                  [disabled]="!aboutFile || uploading.about"
                >
                  {{ uploading.about ? "Uploading..." : "Upload About Photo" }}
                </button>
                <button
                  class="btn btn-danger"
                  *ngIf="profile.aboutImage"
                  (click)="removeImage('aboutImage')"
                >
                  Remove
                </button>
              </div>
              <div class="upload-success" *ngIf="uploadSuccess.about">
        ...
        <div class="section-card">
          ...
          <div class="form-group">
            <label
              >Main Tagline
              <span class="hint"
                >(the large heading visitors see first)</span
              ></label
            >
            <input
              type="text"
              [(ngModel)]="profile.tagline"
              placeholder="e.g. Helping you stay organized, productive, and stress-free"
            />
          </div>
          <div class="form-group">
            ...
            <input
              ...
              placeholder="e.g. Professional Business Operations Consultant"
            />
          </div>
        </div>
...
export class ProfilePageComponent implements OnInit {
  ...
  setFile(file: File, field: "hero" | "about") {
    ...
    reader.onload = (e) => {
      if (field === "hero") {
        this.heroFile = file;
        this.heroPreview = e.target?.result as string;
      } else {
        this.aboutFile = file;
        this.aboutPreview = e.target?.result as string;
      }
    };
  ...
  uploadImage(field: "hero" | "about") {
    ...
    this.http
      .post<{ url: string }>(
        `${this.apiBase}/profile/upload/${endpoint}`,
        formData
      )
      .subscribe({
        next: (res) => {
