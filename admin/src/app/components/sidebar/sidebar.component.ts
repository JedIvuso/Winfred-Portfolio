...
@Component({
  ...
  template: `
    <aside class="sidebar">
      ...
      <nav class="sidebar-nav">
        ...
        <a routerLink="/testimonials" routerLinkActive="active" class="nav-item">
          <span class="nav-icon">💬</span>
      ...
      <div class="sidebar-footer">
        <a href="http://localhost:4200" target="_blank" class="view-site">
  ...
  styles: [`
    ...
    .logo-name { color: white; font-weight: 700; font-size: 0.95rem; }
    .logo-sub { color: rgba(255,255,255,0.45); font-size: 0.75rem; }
    .sidebar-nav {
      flex: 1;
      padding: 16px 12px;
      display: flex;
    ...
    .view-site {
      ...
      font-size: 0.85rem;
      font-weight: 500;
      &:hover { background: rgba(59,91,219,0.5); color: white; }
    }
  `]
})
