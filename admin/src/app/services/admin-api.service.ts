...
export class AdminApiService {
  ...
  private base = "https://winfred-portfolio-production.up.railway.app/api";
  ...
  getTestimonials(): Observable<Testimonial[]> {
    return this.http.get<Testimonial[]>(`${this.base}/testimonials/admin`);
  }
  ...
  getServices(): Observable<Service[]> {
    return this.http.get<Service[]>(`${this.base}/services/admin`);
  }
  ...
  getTools(): Observable<Tool[]> {
    return this.http.get<Tool[]>(`${this.base}/tools/admin`);
  }
  createTool(data: Partial<Tool>): Observable<Tool> {
    return this.http.post<Tool>(`${this.base}/tools`, data);
  }
  updateTool(id: number, data: Partial<Tool>): Observable<Tool> {
    return this.http.put<Tool>(`${this.base}/tools/${id}`, data);
  }
  deleteTool(id: number): Observable<any> {
    return this.http.delete(`${this.base}/tools/${id}`);
  }
}
